...
class Automato:
    ...
    def verificar_estados_inacessiveis(self):
        ...
        if temp_bool:
            print("O autômato possui estados inacessiveis!")
            opcao = input("Deseja remover os estados inacessiveis do autômato? (s/n) ")
            if opcao == "s":
                nome_arquivo = input("Insira o nome do arquivo: ")
                self.salvar_automato(auto, nome_arquivo)
        else:
            print("O autômato não possui estados inacessiveis!")
